...
class Network(nn.Module):
    def __init__(self):
        ...
        self.SPRMencoder = SRMLayer(N_DIMENSION)
...
class FocalLoss(nn.Module):
    ...
    def __init__(self, weight=None, reduction='mean',alpha = 1, gamma=0.1, eps=1e-7):
